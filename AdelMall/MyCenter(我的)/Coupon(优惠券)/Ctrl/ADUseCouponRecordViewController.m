...
- (void)handleTransferResult:(NSDictionary *)result more:(BOOL)more{
    ...
    NSArray *dataArr = @[@{@"id":@"123456",@"couponName":@"新人专享红包购物券",@"couponPrice":@"100.00",@"couponSeries":@"家庭智能门锁",@"couponUseTime":@"2018-01-01 15:00"},@{@"id":@"123456",@"couponName":@"新人专享红包购物券",@"couponPrice":@"100.00",@"couponSeries":@"家庭智能门锁",@"couponUseTime":@"2018-01-01 15:00"}];
    ...
    for (NSDictionary *dic in dataArr) {
        ...
        ADUseCouponModel *model = [ADUseCouponModel mj_objectWithKeyValues:dic];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.goodsTable.data.count > indexPath.row) {
        ADUseCouponModel *model = self.goodsTable.data[indexPath.row];
        cell.model = model;
    }
