...
#import "ADHomeSearchView.h"

@interface ADHomeSearchView ()
...
@implementation ADHomeSearchView
...
//    [self addSubview:_leftItemButton];
    ...
    [_searchButton setTitle:@"输入您要的商品名称" forState:0];
    [_searchButton setTitleColor:[UIColor lightGrayColor] forState:0];
    _searchButton.titleLabel.font = PFR13Font;
    [_searchButton setImage:[UIImage imageNamed:@"home_ico_search"] forState:0];
