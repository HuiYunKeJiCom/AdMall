...
#import "ADMyCenterViewController.h"//我的
...
//我的
@property (nonatomic, weak) ADMyCenterViewController *beautyMsgVc;
...
//
                            @{MallClassKey  : @"ADHomePageViewController",
                              MallTitleKey  : @"首页",
                              MallImgKey    : @"ico_home",
                              MallSelImgKey : @"ico_home_on"},

                            @{MallClassKey  : @"DCCommodityViewController",
                              MallTitleKey  : @"分类",
                              MallImgKey    : @"ico_category",
                              MallSelImgKey : @"ico_category_on"},

                            @{MallClassKey  : @"LZCartViewController",
                              MallTitleKey  : @"购物车",
                              MallImgKey    : @"ico_mainbuycar",
                              MallSelImgKey : @"ico_mainbuycar_on"},
                            
                            @{MallClassKey  : @"ADMyCenterViewController",
                              MallTitleKey  : @"我的",
                              MallImgKey    : @"ico_my",
                              MallSelImgKey : @"ico_my_on"},
    ...
    [childArray enumerateObjectsUsingBlock:^(NSDictionary *dict, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [item setTitlePositionAdjustment:UIOffsetMake(-5,-5)];
