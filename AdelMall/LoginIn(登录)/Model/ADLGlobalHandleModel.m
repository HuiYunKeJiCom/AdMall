...
-(void)saveCurrentUser:(ADLUserModel *)CurrentUser {
    ...
    NSDictionary *dic = [[NSDictionary alloc] initWithObjectsAndKeys:
                         ...
                         [NSString limitStringNotEmpty:CurrentUser.nickName],@"nickName",
                         [NSString limitStringNotEmpty:CurrentUser.phone],@"phone",
                         [NSString limitStringNotEmpty:CurrentUser.nationcode],@"nationcode",
                         [NSString limitStringNotEmpty:CurrentUser.pictureUrl],@"pictureUrl",
                         [NSString limitStringNotEmpty:CurrentUser.gender],@"gender",
                         [NSString limitStringNotEmpty:CurrentUser.password],@"password",
                         [NSString limitStringNotEmpty:CurrentUser.mobile],@"mobile",
                         [NSString limitStringNotEmpty:CurrentUser.weixin],@"weixin",
                         [NSString limitStringNotEmpty:CurrentUser.qq],@"qq",
                         [NSString limitStringNotEmpty:CurrentUser.weibo],@"weibo",
                         [NSString limitStringNotEmpty:CurrentUser.email],@"email",
                         [NSString limitStringNotEmpty:CurrentUser.name],@"name",
                         [NSString limitStringNotEmpty:CurrentUser.userType],@"userType",
                         [NSString limitStringNotEmpty:CurrentUser.loginTime],@"loginTime",nil];
