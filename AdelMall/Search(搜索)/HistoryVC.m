...
#import "ADGoodsListViewController.h"//商品列表
...
- (void)creatSearchNaviBar{
    ...
    @LLWeakObj(self);
    [searchNaviBarView showbackBtnWith:[UIImage imageNamed:@"navigation_back_normal"] onClick:^(UIButton *btn) {
        @LLStrongObj(self);
...
//            @LLStrongObj(searShopVC);
            ...
            goodsListVC.titleString = searchBar.text;
            goodsListVC.index = 0;
